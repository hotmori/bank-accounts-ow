...
with r as
(select a_op.*,
        lead(a_op.transaction_time/*, 1,  to_timestamp('9999/12/31 10:00:00', 'YYYY/MM/DD HH:MI:SS')  */) 
...
param_set as (
select --to_timestamp('2017/11/05 09:05:00', 'YYYY/MM/DD HH:MI:SS') given_date
       --to_timestamp('&given_date', 'YYYY/MM/DD HH:MI:SS') given_date
...
with
param_set as (
select to_timestamp('2017/11/01 09:05:00', 'YYYY/MM/DD HH:MI:SS') date_from,
       to_timestamp('2017/11/04 09:05:00', 'YYYY/MM/DD HH:MI:SS') date_to,
       6 accountid
  from dual
)
...
( select a_op.accountid
  ...
  where a_op.accountid = 1010
   and a_op.transaction_time >= to_timestamp('2015/11/01 09:05:00', 'YYYY/MM/DD HH:MI:SS') -- time_from
   and a_op.transaction_time < to_timestamp('2018/11/01 09:05:00', 'YYYY/MM/DD HH:MI:SS') -- time_to
